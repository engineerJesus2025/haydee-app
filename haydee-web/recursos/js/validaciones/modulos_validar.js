...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (inputNombre) {
        inputNombre.addEventListener('keypress', e => Validador.bloquearTeclasInvalidas(e, Patrones.teclasModulo));
        inputNombre.addEventListener('keyup', e => Validador.evaluarInput(e.target, Patrones.textoModulo, 'Mínimo 3 letras'));
    }
});

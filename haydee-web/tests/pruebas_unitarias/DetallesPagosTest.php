...
final class DetallesPagosTest extends TestCase
{
    ...
    public function testRegistroExitoso()
    {
        ...
        $this->detalles_pago->set_tasa_dolar(5);
    ...
    public function testValidacionesDelBackendRegistrar(array $input, string $expectedMessageFragment)
    {
        ...
        if (isset($input['tasa_dolar']))
            $this->detalles_pago->set_tasa_dolar($input['tasa_dolar']);
    ...
    public static function providerDatosInvalidosRegistrar(): array
    {
        return [
            ...
            'Campos vacíos' => [
                ['fecha' => '', 'monto' => '', 'tasa_dolar' => '', 'tipo_pago' => '', 'pago_id' => ''],
                "Uno o varios de los campos requeridos estan vacios"
            ],
            'Fecha inválida' => [
                ['fecha' => 20240510, 'monto' => 100, 'tasa_dolar' => 3.5, 'tipo_pago' => 'Transferencia', 'pago_id' => 1],
                "Fecha"
            ],
            'Monto inválido (no numérico)' => [
                ['fecha' => '2024-05-10', 'monto' => 'ABC', 'tasa_dolar' => 3.5, 'tipo_pago' => 'Transferencia', 'pago_id' => 1],
                "Monto"
            ],
            'Monto inválido (formato incorrecto)' => [
                ['fecha' => '2024-05-10', 'monto' => '100.999', 'tasa_dolar' => 3.5, 'tipo_pago' => 'Transferencia', 'pago_id' => 1],
                "Monto"
            ],
            'Monto en dólar inválido (no numérico)' => [
                ['fecha' => '2024-05-10', 'monto' => 100, 'tasa_dolar' => 'XYZ', 'tipo_pago' => 'Transferencia', 'pago_id' => 1],
                "Monto"
            ],
            'Monto en dólar inválido (formato incorrecto)' => [
                ['fecha' => '2024-05-10', 'monto' => 100, 'tasa_dolar' => '3.555', 'tipo_pago' => 'Transferencia', 'pago_id' => 1],
                "Monto"
            ],
            'Tipo de pago inválido (no string)' => [
                ['fecha' => '2024-05-10', 'monto' => 100, 'tasa_dolar' => 3.5, 'tipo_pago' => 123, 'pago_id' => 1],
                "Método de Pago"
            ],
            'ID de pago inválido (no numérico)' => [
                ['fecha' => '2024-05-10', 'monto' => 100, 'tasa_dolar' => 3.5, 'tipo_pago' => 'Transferencia', 'pago_id' => 'A1'],

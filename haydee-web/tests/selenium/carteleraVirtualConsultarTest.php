...
class carteleraVirtualConsultarTest extends TestCase
{
    private $driver;
    ...
    public function testConsultartipoGastoUI()
    {
        // -----------------------------------------------------------------
        ...
        $this->driver->wait(10, 500)->until(
            function () {
                return $this->driver->findElement(WebDriverBy::xpath("//h2[contains(text(), 'GESTIONAR CARTELERA VIRTUAL')]"));
            }
        );
        ...
        $this->assertTrue(true, "La tabla de cartelera virtual se cargó correctamente (desapareció 'Cargando...').");
    }
}
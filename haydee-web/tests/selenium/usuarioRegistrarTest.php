<?php
// tests/Selenium/usuarioRegistrarTest.php
...
class usuarioRegistrarTest extends TestCase
{
    private $driver;
    ...
    public function testRegistrarUsuarioUI()
    {
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // PASO 3: Abrir el modal de "regsitrar usuario"
        // -----------------------------------------------------------------
        
        $test_nombre = 'test';
        $test_apellido = 'test';
        $test_correo = 'testregistrar@gmail.com';
        $test_contra = '12345';
       ...
       // -----------------------------------------------------------------
        ...
        $tableSelector = WebDriverBy::id('tabla_usuario'); // Asegúrate que tu tabla tenga este ID
        ...
        $this->driver->wait(10)->until(
            ...
            "FALLO: El usuario registrado ($test_correo) no apareció en la tabla."
        );

        $this->assertTrue(true, "Registro de usuario completado exitosamente.");
    }
}
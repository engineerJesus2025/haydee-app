                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-12">
                            <div class="card mb-3 shadow" title="Reportes Estadisticos">
                                <a href="?pagina=reportes_controlador.php&accion=reportes_estadisticos" class="text-decoration-none text-black">
                                    <div class="card-header text-center bg-white border-bottom-0 p-0">
                                        <i class="bi bi-clipboard-data" style="font-size: 5rem !important;"></i>
                                    </div>
                                    <div class="card-body text-center p-0 mb-3">
                                        <p class="card-title fw-bold">Reportes Estadísticos</p>
                                    </div>
                                </a>
                            </div>
                        </div>

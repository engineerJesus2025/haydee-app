...
<div class="row text-center justify-content-center">
	...
	<div class="col-8 mb-4" style="margin: auto;">
		<p class="p_contenido"><b class="text-white" style="color: white">_____ </b>Por medio de la presente se hace constar, que <?php echo ($registro_propietario["sexo"] == "Masculino")?"el":"la" ?> ciudadan<?php echo ($registro_propietario["sexo"] == "Masculino")?"o":"a" ?> <?php echo $registro_propietario["nombre"] . " " . $registro_propietario["apellido"] ?> portador<?php echo ($registro_propietario["sexo"] == "Masculino")?"":"a" ?> de la cédula de identidad número V-<?php echo $registro_propietario["cedula"] ?> vive en el apartamento Nº <?php echo $registro_propietario["apartamento"] ?>, piso <?php echo explode("-", $registro_propietario["apartamento"])[0] ?>, del edificio Haydee ubicado en la carrera 22 entre calles 13 y 14, municipio Iribarren parroquia Catedral del estado Lara, Barquisimeto.</p>
	</div>

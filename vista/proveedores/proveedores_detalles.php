            ...
            <div class="modal-body rounded-bottom p-0">
                ...
                <div class="p-4">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex flex-column justify-content-center py-3 border-bottom rounded-top">
                            <div class="d-flex align-items-center text-muted mb-1">
                                <i class="bi bi-tools fs-5 me-3 text-primary"></i>
                                <span class="fw-semibold">Servicio que Presta</span>
                            </div>
                            <span id="vp_servicio" class="fw-bold  text-wrap ms-4 ps-2">---</span>
                        </li>
                        
                        <li class="list-group-item d-flex flex-column justify-content-center py-3 border-bottom-0 rounded-bottom">
                            <div class="d-flex align-items-center text-muted mb-1">
                                <i class="bi bi-geo-alt fs-5 me-3 text-primary"></i>
                                <span class="fw-semibold">Dirección</span>
                            </div>
                            <span id="vp_direccion" class="fw-bold  text-wrap ms-4 ps-2">---</span>
                        </li>

    ...
    <div class="row m-3">
        <div class="col-12">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control nombre_tipo_gasto" name="nombre_tipo_gasto" id="nombre_tipo_gasto" placeholder="Nombre del Tipo de Gasto" aria-label="nombre_tipo_gasto" aria-describedby="basic-addon1" minlength="3" maxlength="50">

    ...
    <div class="row m-3">
        ...
        <div class="col-lg-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control codigo" name="codigo" id="codigo" placeholder="Código" aria-label="codigo" aria-describedby="basic-addon1" minlength="3" maxlength="30">
                <span class="w-100 invalid-feedback"></span>
            </div>
        </div>
    </div>

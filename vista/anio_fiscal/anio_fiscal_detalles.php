                ...
                <div class="p-4">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                            ...
                            <span id="vp_descripcion" class="fw-bold text-dark text-end text-wrap ms-3">---</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3">
                            ...
                            <span id="vp_fecha_inicio" class="fw-bold text-dark text-end">---</span>
                        </li>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0 py-3 border-bottom-0">
                            ...
                            <span id="vp_fecha_cierre" class="fw-bold text-dark text-end">---</span>
                        </li>

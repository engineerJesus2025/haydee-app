                    ...
                    <div class="row m-3">
                        <div class="col-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="border border-dark rounded-end form-control" name="accion" id="accion" placeholder="Ej: Registrar" aria-label="accion" maxlength="50" autofocus>

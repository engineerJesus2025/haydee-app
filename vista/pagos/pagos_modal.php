    ...
    <div class="row m-3">
        <div class="col-lg-4">
            ...
            <div class="input-group mb-3">
                ...
                <select class="border border-dark form-select apartamento_id" aria-label="Default select example"
    ...
    <div class="row m-3">
        <div class="col-lg-4">
            ...
            <div class="input-group mb-3">
                ...
                <select class="border border-dark form-select estado" aria-label="Default select example" id="estado"
                    for="estado" name="estado">
        ...
        <div class="col-lg-8 mb-3">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="border border-dark form-control observacion" name="observacion"
                    id="observacion" placeholder="Puede dejar una breve descripción" aria-label="observacion"

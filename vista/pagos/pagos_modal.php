                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6 mb-3">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="date" class="border border-dark form-control fecha_pago" name="fecha_pago[]">
                                            <span class="w-100 invalid-feedback"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 mb-3">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <select class="border border-dark form-select tipo_pago" name="tipo_pago[]">
                                ...
                                <div class="row campos-bancarios d-none">
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-3">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <select class="border border-dark form-select banco_id" name="banco_id[]">
        ...
        <div class="card-body">
            ...
            <div class="row campos-bancarios d-none">
                <div class="col-lg-3 col-md-6 mb-3">
                    ...
                    <div class="input-group has-validation">
                        <span class="border border-primary input-group-text"><i class="bi bi-123"></i></span>
                        <input type="text" class="border border-dark form-control referencia" name="referencia[]" placeholder="Nro de recibo">
                        <span class="w-100 invalid-feedback"></span>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 mb-3">
                    ...
                    <div class="input-group has-validation">
                        <span class="border border-primary input-group-text"><i class="bi bi-bank"></i></span>
                        <select class="border border-dark form-select banco_id">
                            <option selected hidden value="">Escoja el Banco</option>
                            <?php foreach ($registro_banco as $banco): ?>
                                <option value="<?php echo $banco["id_banco"] ?>"><?php echo $banco["nombre_banco"] ?></option>
                            <?php endforeach; ?>

                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="date" class="form-control fecha_admin" name="fecha[]">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select tipo_pago_admin" name="tipo_pago[]">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 campos-bancarios d-none">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select banco_admin" name="banco_id[]">

<form action="?pagina=conciliacion_bancaria_controlador.php&accion=guardar" method="POST" id="form_movimientos" name="form_movimientos">
    <div class="row m-3">
        <div class="col-md-4">
    ...
    <div class="row m-3">
        ...
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <select class="form-select" aria-label="Default select example" name="tipo_movimiento" id="tipo_movimiento" form="form_movimientos" disabled readonly>
    ...
    <h5 class="text-center" id="registro_sistema">Registro del sistema:</h5>
    <div class="row m-3">
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="monto_sistema" id="monto_sistema" placeholder="Monto según el sistema" aria-label="monto_sistema" aria-describedby="basic-addon1" minlength="5" maxlength="50" disabled readonly>
                <span class="w-100"></span>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="pago_gasto_sistema" id="pago_gasto_sistema" placeholder="Pago realizado por" aria-label="pago_gasto_sistema" aria-describedby="basic-addon1" minlength="5" maxlength="50" disabled readonly>
                <span class="w-100"></span>
            </div>
        </div>
    </div>
    <div class="row m-3">
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="fecha_sistema" id="fecha_sistema" placeholder="Fecha de registro de Pago" aria-label="fecha_sistema" aria-describedby="basic-addon1" minlength="5" maxlength="50" disabled readonly>
                <span class="w-100"></span>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="referencia_sistema" id="referencia_sistema" placeholder="Referencia Según el Sistema" aria-label="referencia_sistema" aria-describedby="basic-addon1" minlength="5" maxlength="50" disabled readonly>
                <span class="w-100"></span>
            </div>
        </div>
    </div>
    <h5 class="text-center" id="resumen">Resumen:</h5>
    <div class="row m-3">
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control me-1" name="diferencia_tipo" id="diferencia_tipo" placeholder="Nombre diferencia_tipo" aria-label="diferencia_tipo" aria-describedby="basic-addon1" minlength="5" maxlength="50" disabled readonly>
                 <input type="text" class="form-control" name="diferencia_monto" id="diferencia_monto" placeholder="diferencia_monto" aria-label="diferencia_monto" aria-describedby="basic-addon1" minlength="5" maxlength="50" disabled readonly>
                <span class="w-100"></span>
            </div>
        </div>        
        <div class="col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="estado" id="estado" placeholder="Estado" aria-label="estado" aria-describedby="basic-addon1" minlength="5" maxlength="50" disabled readonly>
                <span class="w-100"></span>
            </div>
        </div>
    </div>
    <div class="row m-3">
        <div class="col-md-12 text-center">
            <button class="btn btn-primary" type="submit" id="boton_formulario">Registrar Movimiento</button>
        </div>
    </div>
</form>
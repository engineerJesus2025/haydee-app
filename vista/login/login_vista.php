            ...
            <div class="row p-5">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="card mt-5 shadow-lg rounded">
                        <div class="card-body">
                            <form action="?pagina=login_controlador.php&accion=entrar" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="usuario" class="form-control" placeholder="Correo" name="correo" aria-label="Username" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="input-group mb-3">
                                    ...
                                    <div class="col-md-12 text-center p-3">
                                        <button type="submit" class="btn btn-primary rounded shadow">Ingresar <i class="bi bi-send-fill"></i></button>
                                    </div>
                                </div>

        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-header bg-primary text-white border-bottom-0">
                <h5 class="modal-title fw-bold" id="titulo_modal_detalles">
                    <i class="bi bi-person-vcard me-2"></i>Perfil del Usuario
                </h5>
            ...
            <div class="modal-body p-0">
                <div class="bg-light p-4 text-center border-bottom">
                    ...
                    <h5 id="vp_nombre_completo" class="text-dark mb-2 fw-bold text-wrap" style="word-break: break-word;">---</h5>
                    
                    <span id="vp_rol_badge" class="badge bg-secondary fs-6 px-3 py-2 shadow-sm">---</span>
                </div>

                <div class="p-3">
                    <ul class="list-group list-group-flush">
                        
                        <li class="list-group-item d-flex flex-column justify-content-center px-2 py-3 border-bottom-0 text-center">
                            ...
                            <span id="vp_correo" class="fw-bold text-dark text-wrap">---</span>
                        </li>

<?php
// Diccionario de iconos basado en navbar.php
$iconos_modulos = [
    'pagos'             => 'bi-cash-coin',
    'gastos'            => 'bi-cart-plus',
    'caja_chica'        => 'bi-bank2',
        ...
        <div class="modal-content card shadow-lg"> 
            <div class="modal-header bg-primary text-white">
                <h1 class="modal-title fs-5">
                    ...
                    <span class="ms-2" id="titulo_modal">Registrar Rol</span>
                </h1>
                   ...
                   <div class="row mb-4">
                       <div class="col-md-4">
                           ...
                           <div class="input-group mb-3">
                               ...
                               <input type="text" class="rounded-end form-control nombre_rol" name="nombre" id="nombre" placeholder="Ejem: Contador" aria-label="nombre" aria-describedby="basic-addon1" minlength="3" maxlength="30" autofocus>
                               <span class="w-100 invalid-feedback"></span>
                           </div>
                       </div>
                   </div>
                   <div class="table-responsive shadow-sm border rounded" style="max-height: 500px; overflow-y: auto;">
                       <table id="tabla_permisos" class="table table-hover align-top mb-0 tabla-permisos">
                           <thead class="sticky-top shadow-sm" style="background-color: var(--ch-table-vp-header-bg); color: var(--ch-table-vp-header-text); border-bottom: 2px solid var(--ch-table-border);">
                               <tr>
                                   <!-- Eliminamos la clase text-secondary para que herede el color de la cabecera -->
                                   <th style="width: 35%; color: inherit;" class="py-3" scope="col">
                                       <i class="bi bi-grid-1x2 me-2"></i>Módulo del Sistema
                                   </th>
                                   <th style="width: 65%; color: inherit;" class="py-3" scope="col">
                                   ...
                                   <tr data-modulo="<?php echo $registro_modulo['id_modulo'] ?>">
                                       <td>
                                           <div class="d-flex flex-column gap-2 py-2 ps-2">
                                               <span class="fw-bold nombre-modulo d-flex align-items-center" style="letter-spacing: 0.5px;">
                                                   <div class="p-2 nombre-modulo me-2">
                                               ...
                                               <div class="accordion-item border rounded">
                                                   <h2 class="accordion-header">
                                                       <button class="accordion-button collapsed py-2 px-3 shadow-none" type="button" 
                                                           ...
                                                           <span class="fw-semibold" style="font-size: 1.10rem;">
            ...
            <div class="modal-footer">
                <div class="col-md-12 text-end">
                    ...
                    <button class="btn btn-primary px-3 shadow-sm mb-2" type="submit" id="boton_formulario">
                        ...
                        <span id="texto_boton_formulario">Guardar Rol</span>
                    </button>
                </div>
            </div>
         </div>

<div class="header" id="header">
	<div class="l-navbar" id="nav-bar">
	    <nav class="nav">
	        <div>
	        	<a href="?pagina=inicio_controlador.php&accion=inicio" class="nav_logo"> 
		        ...
		        <div class="nav_list"> 
		        	...
		        	<a href="#" class="nav_link"> 
		        		...
		        		<span class="nav_name">Control de Efectivo</span> 
		        	</a> 
		        	<a href="#" class="nav_link"> 
		        	...
		        	<a href="?pagina=usuario_controlador.php&accion=inicio" class="nav_link"> 
		        		<i class="bi bi-person-badge-fill nav_logo-icon"></i>
		        		<span class="nav_name">Usuarios</span> 
		        	</a>
		        	<a href="?pagina=seguridad_controlador.php&accion=inicio" class="nav_link"> 

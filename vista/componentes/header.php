...
<header class="header d-flex justify-content-between align-items-center px-3 bg-white shadow-sm" id="header" style="height: 60px; transition: .5s;">
    ...
    <div class="d-flex align-items-center">
        <div class="header_toggle me-3">
            <i class='bi bi-list fs-3 text-dark transition-icon' id="header-toggle" style="cursor: pointer;"></i>
        </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end shadow-lg border-0 dropdown-menu-notifications p-0" aria-labelledby="notificaciones-toggle" id="notificaciones-list">
                ...
                <div class="dropdown-header py-3 px-3 d-flex justify-content-between align-items-center border-bottom bg-white rounded-top">
                    ...
                    <a href="#" class="text-primary small text-decoration-none <?php echo (empty($_SESSION["notificaciones"])) ? 'd-none' : ''; ?>" id="marcar-todas-leidas" title="Marcar todas como leídas" data-tooltip="true">
                ...
                <div class="dropdown-footer text-center border-top bg-light rounded-bottom">
                    <a href="?pagina=notificaciones&accion=inicio" class="text-primary fw-semibold small text-decoration-none d-block py-2" title="Ver el historial completo" data-tooltip="true">Ver el historial completo</a>
                </div>
            </div>
        </div>

        <div class="dropdown">
            <button class="btn bg-none text-dark fw-bold dropdown-toggle border-0 d-flex align-items-center px-2 py-1 rounded user-profile-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">

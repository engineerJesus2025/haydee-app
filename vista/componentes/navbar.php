...
<div class="l-navbar show" id="nav-bar">
    <nav class="nav">
        <div class="nav_logo_container">
            <a href="?pagina=inicio&accion=inicio"
        ...
        <div id="nav-accordion" class="w-100 nav_scrollable_content">
            <div class="nav_list mt-3 ps-2 pe-2">
                ...
                <a href="?pagina=pagos&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "pagos") ? "active" : ''; ?>"
                    title="Pagos">
                ...
                <a href="?pagina=gastos&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "gastos") ? "active" : ''; ?>"
                    title="Gastos">
                ...
                <a href="?pagina=caja_chica&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "caja_chica") ? "active" : ''; ?>"
                    title="Caja Chica">
                ...
                <a href="?pagina=mensualidad&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "mensualidad")?"active":''; ?>"
                    title="Mensualidad">
                ...
                <a href="?pagina=cartelera_virtual&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "cartelera_virtual") ? "active" : ''; ?>"
                ...
                <a href="?pagina=apartamentos&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "apartamentos") ? "active" : ''; ?>"
                    title="Apartamentos">
                ...
                <a href="?pagina=solicitud_gasto&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "solicitud_gasto")?"active":''; ?>"
                ...
                <a href="?pagina=presupuesto&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "presupuesto")?"active":''; ?>"
                ...
                <a href="?pagina=anio_fiscal&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "anio_fiscal")?"active":''; ?>"
                    title="Año Fiscal">
                ...
                <?php if (Sesiones::tienePermiso(GESTIONAR_CONFIGURACION, CONSULTAR)): 
                    $configuracion = ($_GET["pagina"] == "proveedores" || $_GET["pagina"] == "bancos" || $_GET["pagina"] == "tipo_gasto")?true:false;
                    ?>
                ...
                <div class="collapse <?php echo ($configuracion)?'show':'';?>" id="collapse_configuracion" data-bs-parent="#nav-accordion">
                    ...
                    <a href="?pagina=proveedores&accion=inicio"
                        class="nav_link <?php echo ($_GET["pagina"] == "proveedores")?"active":''; ?>">
                    ...
                    <a href="?pagina=bancos&accion=inicio"
                        class="nav_link <?php echo ($_GET["pagina"] == "bancos")?"active":''; ?>">
                    ...
                    <a href="?pagina=tipo_gasto&accion=inicio"
                        class="nav_link <?php echo ($_GET["pagina"] == "tipo_gasto")?"active":''; ?>">
                ...
                <a href="?pagina=usuario&accion=inicio"
                    class="nav_link <?php echo ($_GET['pagina'] == 'usuario' || $_GET['accion'] == 'perfil') ? 'active' : ''; ?>"
                    title="Usuarios">
                ...
                <?php if (Sesiones::tienePermiso(GESTIONAR_SEGURIDAD, CONSULTAR)): 
                    $seguridad = ($_GET["pagina"] == "rol" || $_GET["pagina"] == "bitacora")?true:false;
                    ?>
                ...
                <div class="collapse <?php echo ($seguridad)?'show':'';?>" id="collapse_seguridad" data-bs-parent="#nav-accordion">
                    ...
                    <a href="?pagina=rol&accion=inicio"
                        class="nav_link <?php echo ($_GET["pagina"] == "rol")?"active":''; ?>">
                    ...
                    <a href="?pagina=bitacora&accion=inicio"
                        class="nav_link <?php echo ($_GET["pagina"] == "bitacora")?"active":''; ?>">
                    ...
                    <a href="?pagina=permisos&accion=inicio"
                        class="nav_link <?php echo ($_GET["pagina"] == "permisos")?"active":''; ?>">
                    ...
                    <a href="?pagina=modulos&accion=inicio"
                        class="nav_link <?php echo ($_GET["pagina"] == "modulos")?"active":''; ?>">
                ...
                <a href="?pagina=notificaciones&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "notificaciones") ? "active" : ''; ?>"
                ...
                <a href="?pagina=mantenimiento&accion=inicio"
                    class="nav_link <?php echo ($_GET["pagina"] == "mantenimiento") ? "active" : ''; ?>"
                    title="Mantenimiento">

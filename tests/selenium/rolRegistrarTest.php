<?php
// tests/Selenium/rolRegistrarTest.php
...
class rolRegistrarTest extends TestCase
{
    private $driver;
    ...
    public function testRegistrarRolUI()
    {
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // PASO 3: Abrir el modal de "regsitrar rol"
        // -----------------------------------------------------------------
       ...
       // -----------------------------------------------------------------
        ...
        $tableSelector = WebDriverBy::id('tabla_roles'); // Asegúrate que tu tabla tenga este ID
        ...
        $this->driver->wait(10)->until(
            ...
            "FALLO: El rol registrado ($test_nombre) no apareció en la tabla."
        );

        $this->assertTrue(true, "Registro de rol completado exitosamente.");
    }
}
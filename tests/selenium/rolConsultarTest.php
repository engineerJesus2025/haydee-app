<?php
// tests/Selenium/rolConsultarTest.php
...
class rolConsultarTest extends TestCase
{
    ...
    public function testConsultarRolUI()
    {
        // -----------------------------------------------------------------
        ...
        $loadingSelector = WebDriverBy::xpath("//table[@id='tabla_roles']//h4[contains(text(), 'Cargando...')]");
        ...
        $this->assertTrue(true, "La tabla de roles se cargó correctamente (desapareció 'Cargando...').");
    }
}
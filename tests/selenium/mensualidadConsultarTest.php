<?php
// tests/Selenium/mensualidadConsultarTest.php
...
class mensualidadConsultarTest extends TestCase
{
    private $driver;
    ...
    public function testConsultarMensualidadUI()
    {
        // -----------------------------------------------------------------
        ...
        $loadingSelector = WebDriverBy::xpath("//table[@id='tabla_mensualidad']//h4[contains(text(), 'Cargando...')]");

<?php
// tests/Selenium/mensualidadRegistrarTest.php
...
class mensualidadRegistrarTest extends TestCase
{
    private $driver;
    ...
    public function testRegistrarMensualidadUI()
    {
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // PASO 3: Abrir el modal de "registrar mensualidad"
        // -----------------------------------------------------------------
        ...
        $tableSelector = WebDriverBy::id('tabla_mensualidad'); // Asegúrate que tu tabla tenga este ID
        ...
        $this->driver->wait(10)->until(
            ...
            "FALLO: El mensualidad registrado (2025) no apareció en la tabla."
        );

        $this->assertTrue(true, "Registro de mensualidad completado exitosamente.");
    }
}
<?php
// tests/Selenium/presupuestoConsultarTest.php
...
class presupuestoConsultarTest extends TestCase
{
    private $driver;
    ...
    public function testConsultarPresupuestoUI()
    {
        // -----------------------------------------------------------------
        ...
        $this->driver->get('http://localhost/haydee-app/?pagina=presupuesto_controlador.php&accion=inicio');
        ...
        $loadingSelector = WebDriverBy::xpath("//table[@id='tabla_presupuesto']//h4[contains(text(), 'Cargando...')]");
        ...
        $this->assertTrue(true, "La tabla de caja se cargó correctamente (desapareció 'Cargando...').");
    }
}
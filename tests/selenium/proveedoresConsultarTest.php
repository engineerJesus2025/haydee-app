...
class proveedoresConsultarTest extends TestCase
{
    private $driver;
    ...
    public function testConsultarProveedoresUI()
    {
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // PASO 3: Probar la consulta de Proveedores
        // -----------------------------------------------------------------
        ...
        $this->assertTrue(true, "La tabla de proveedores se cargó correctamente (desapareció 'Cargando...').");
    }
}
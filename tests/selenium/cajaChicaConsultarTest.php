<?php
// tests/Selenium/cajaChicaConsultarTest.php
...
class cajaChicaConsultarTest extends TestCase
{
    private $driver;
    ...
    public function testConsultarCajaChicaUI()
    {
        // -----------------------------------------------------------------
        ...
        $this->driver->get('http://localhost/haydee-app/?pagina=caja_chica_controlador.php&accion=inicio');
        ...
        $loadingSelector = WebDriverBy::xpath("//table[@id='tabla_registros_sistema']//h4[contains(text(), 'Cargando...')]");

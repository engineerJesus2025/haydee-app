<?php
// tests/Selenium/anioFiscalConsultarTest.php
...
class anioFiscalConsultarTest extends TestCase
{
    private $driver;
    ...
    public function testConsultarAniosFiscalesUI()
    {
        // -----------------------------------------------------------------
        ...
        $this->driver->wait(10, 500)->until(
            function () {
                return $this->driver->findElement(WebDriverBy::xpath("//h2[contains(text(), 'GESTIONAR AÑOS FISCALES')]"));
            }
        );
        ...
        $this->assertTrue(true, "La tabla de anios fiscales se cargó correctamente (desapareció 'Cargando...').");
    }
}
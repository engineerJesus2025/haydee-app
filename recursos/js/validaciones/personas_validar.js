$(document).ready(function(){
	...
	$("#cedula").on("keyup",function(){
		...
		$(this),this.nextElementSibling,"Debe ingresar la cedula de la Persona");
	});
	...
	$("#nombre").on("keyup",function(){
		...
		$(this),this.nextElementSibling,"Debe ingresar el nombre de la Persona");
	});
	...
	$("#apellido").on("keyup",function(){
		validarKeyUp(/^[A-Za-z \b]{3,30}$/,
		$(this),this.nextElementSibling,"Debe ingresar el apellido de la Persona");
	});
	...
	$("#telefono").on("keyup",function(){
		...
		$(this),this.nextElementSibling,"Debe ingresar un telefono de la Persona");
	});
	...
	$("#boton_formulario").on("click",async function(e){
		...
		if(await validarEnvio(accion)==true){
				Swal.fire({
				title: "¿Estás seguro?",
				text: `¿Está seguro que desea ${accion} a esta Persona?`,
...
async function validarEnvio(accion = "Registrar"){	
        ...
        )==0)
	{
        ...
        /^[A-Za-z \b]{3,30}$/,
        $("#nombre"),document.querySelector("#nombre").nextElementSibling,'Debe ingresar el nombre'
        )==0)
	{
	...
	if (accion == "Registrar") {
		...
		datos.append("id_persona",id_modificar);

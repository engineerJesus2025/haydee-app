...
document.addEventListener("DOMContentLoaded", function() {
    ...
    inputsNombres.forEach(input => {
        ...
        input.addEventListener("keyup", (e) => Validador.evaluarInput(e.target, Patrones.nombre, "Solo texto, no más de 20 caracteres"));
    });
...
async function validarEnvio(accion = "Registrar"){  
    ...
    const nombreV = Validador.evaluarInput(document.querySelector("#nombre"), Patrones.nombre, 'Formato incorrecto');
    const apellidoV = Validador.evaluarInput(document.querySelector("#apellido"), Patrones.nombre, 'Formato incorrecto');

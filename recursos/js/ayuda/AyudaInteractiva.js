const AyudaInteractiva = {
    ...
    inicializar(opciones) {
        ...
        const btnAyudaFlotante = document.getElementById('btn-ayuda-tour');
        const btnAyudaModal = document.getElementById('btn_ayuda_modal');
        ...
        if (btnAyudaFlotante) {
            btnAyudaFlotante.addEventListener('click', () => {
        ...
        // Evento del botón de ayuda para móviles
        if (btnAyudaModal) {
            btnAyudaModal.addEventListener('click', () => {
                // Va directo a los pasos del modal porque este botón solo existe dentro de él
                this.driverActivo = driver({ ...configBase, steps: opciones.pasosModal });
                this.driverActivo.drive();
            });
        }

...
document.getElementById("banco_id").addEventListener("change", function() {
    const seleccionado = this.options[this.selectedIndex];
    
    // Obtener los datos personalizados
    const numero_cuenta = seleccionado.getAttribute("data-numero_cuenta");
	const telefono = seleccionado.getAttribute("data-telefono");
	const cedula = seleccionado.getAttribute("data-cedula");

    // Insertarlos en los campos
    document.getElementById("nro_cuenta").value = numero_cuenta || '';

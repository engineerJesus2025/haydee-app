...
async function registrar() {
    ...
    // Campos múltiples
    let fechas = formulario_usar.querySelectorAll(".fecha_propietario");
    ...
    let tipos_pago = formulario_usar.querySelectorAll(".tipo_pago_propietario");
    let referencias = formulario_usar.querySelectorAll(".referencia");
    let bancos = formulario_usar.querySelectorAll(".banco_propietario");

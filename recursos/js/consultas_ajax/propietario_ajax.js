...
let tabla = document.querySelector("#tabla_propietario");
let boton_formulario = document.querySelector("#boton_formulario");
let modal = new bootstrap.Modal(document.querySelector("#modal_propietario"));
let formulario_usar = document.querySelector("#form_propietario");
...
document.querySelector('#modal_propietario').addEventListener('hidden.bs.modal', () => {
    formulario_usar.reset();
    boton_formulario.removeAttribute("modificar");
    boton_formulario.removeAttribute("id_modificar");
    boton_formulario.textContent = "Registrar";
    document.getElementById("titulo_modal").textContent = "Registrar Propietario";
...
function vaciar_tabla() {
    let cuerpo_tabla = document.querySelector('#tabla_propietario tbody');
...
function llenarTabla(fila) {
    ...
    let id_campo = fila["id_propietario"];

    let nombre_td = document.createElement("td");
    let apellido_td = document.createElement("td");
    let cedula_td = document.createElement("td");
    let telefono_td = document.createElement("td");
    let correo_td = document.createElement("td");
...
function crearBotones(id) {
    ...
    boton_editar.setAttribute("data-bs-target", "#modal_propietario");
...
async function modificar_formulario(e) {
    ...
    boton_formulario.setAttribute("id_modificar", data.id_propietario);
...
function init_data_table() {
    return new DataTable("#tabla_propietario", {
        destroy: true,
        responsive: true,
        "scrollX": true,
        "pageLength": 10,
...
observer.observe(document.querySelector("#tabla_propietario tbody"), {
    childList: true,
    subtree: true
});
...
function reasignarEventos() {
    ...
    Swal.fire({
        title: "Atención",
        text: "¿Está seguro de eliminar este propietario?",

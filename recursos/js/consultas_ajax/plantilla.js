...
let data_table, data_table_detalles, id_eliminado, id_registrado,id_modificar, referencia_an;
...
let formulario_detalles = document.querySelector("#form_detalles_pagos");

// Forma correcta de definir el modal
let modalVistaPrevia = new bootstrap.Modal(document.querySelector("#modal_vista_previa"));
let modalDetalles = new bootstrap.Modal(document.querySelector("#modal_detalles_pagos"));
...
function llenarTabla(fila) {
	...
	fecha_td.textContent = datos.primera_fecha_detalle;
...
async function modificar_formulario(e) {
	...
	mostrarCamposPorTipo(data.tipo_pago);
...
async function mostrarVistaPreviaANTIGUA(e) {
	...
	document.getElementById("vista_fecha").textContent = data.fecha;
	document.getElementById("vista_monto_pago").textContent = data.monto_pago;
	document.getElementById("vista_estado").textContent = data.estado;

...
class Usuario extends Conexion
{
    ...
    public function editar_perfil()
    {
        ...
        $sql = "UPDATE usuarios SET apellido=:apellido,nombre=:nombre,correo=:correo,contrasenia=:contrasenia WHERE id_usuario=:id_usuario";
    ...
    public function cambiar_contrasenia()
    {
        ...
        if ($result) {
            ...
            return ["estatus"=>false,"mensaje"=>"Ha ocurrido un error al intentar cambiar esta contraseña"];
        }
    }
    ...
    {   
        ...
        if (!(isset($this->apellido) && isset($this->nombre) && isset($this->correo) && isset($this->contra))) {return ["estatus"=>false,"mensaje"=>"Uno o varios de los campos requeridos no se recibieron correctamente"];}
        ...
        if (empty($this->apellido) || empty($this->nombre) ||empty($this->correo) || empty($this->contra)) {return ["estatus"=>false,"mensaje"=>"Uno o varios de los campos requeridos estan vacios"];}

        if (!$perfil) {
            if (empty($this->rol_id)) {
                return["estatus"=>false,"mensaje"=>"El cammpo del rol se envio vacío"];
            }
        }

...
$mensualidad_obj->registrar_bitacora(CONSULTAR, GESTIONAR_REPORTES, "TODOS LOS REPORTES");
...
if (isset($_POST["operacion"])){
    ...
    if ($operacion == "consultar_estadisticas_ingresos_egresos"){
        ...
        echo  json_encode($mensualidad_obj->consultar_meses_mensualidad());
    }
...
if ($accion == "cuadro_pagos"){
    ...
    $deudas_globales = $mensualidad_obj->consultar_mensualidades_pendientes();
    ...
    $tasa_dolar = $mensualidad_obj->consultar_tasa_dolar_mensualidades();
    $total_mensual = [];

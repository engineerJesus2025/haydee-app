...
(27, 1000.00, 'Abierto', 'Caja chicas del mes Mayo - 2026', '2026-05-17', 47, 1);
...
(2022, '2026-02-05', 12.00, 'Pago Movil', 132),
...
(132, 'fijo', 1.00, 2, NULL, 2, 'holasssssssssssssssaaa', 1),
...
--
ALTER TABLE `anio_fiscal`
  MODIFY `id_anio_fiscal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `notificaciones`
  MODIFY `id_notificacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251;

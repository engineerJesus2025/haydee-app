...
--
-- Host: mysql-condominioshaydee.alwaysdata.net
-- Generation Time: Oct 08, 2025 at 07:02 AM
...
--
-- Database: `condominioshaydee_haydee`
--
...
-- Procedures
--
CREATE DEFINER=`421243`@`%` PROCEDURE `gestionar_anio_fiscal` ()   BEGIN
...
CREATE DEFINER=`421243`@`%` PROCEDURE `sp_gestion_caja_chica_mensual` ()   sp_block: BEGIN 
...
CREATE DEFINER=`421243`@`%` PROCEDURE `sp_sincronizar_presupuestos_mensualidad` (IN `p_mensualidad_id` INT, IN `p_nuevos_presupuestos_ids` TEXT)   BEGIN
...
CREATE DEFINER=`421243`@`%` PROCEDURE `test` (IN `id` INT)   SELECT * FROM pagos WHERE id_pago = id$$
...
(120, '12312', 'fiabil_1759898152_727.PNG', NULL, 147, 1),
(121, '123123', 'images__2__1759898181_116.png', NULL, 150, 6);
...
(21, 115, 115, 'Abierto', 'Caja chica 2025', '2025-01-01', 24),
...
(147, '2025-10-07', 10, 0, 'Transferencia', 112, 'Pago en transferencia'),
(148, '2010-10-10', 10, 0, 'Efectivo', 112, 'Pago en efectivo'),
(149, '2025-09-10', 12, 0, 'Efectivo', 101, 'pago en efectivo'),
(150, '2025-09-01', 1, 0, 'Pago Movil', 101, 'asdassadasdas');
...
(155, '2025-10-01', 40, 0.22, 'Efectivo', 82),
...
(20, 'transporte', 25, '2025-10-08', 'Pendiente por reposicion', 21, NULL);

--
-- Triggers `movimientos_caja`
--
DELIMITER $$
...
--
-- Indexes for table `banco_transacciones`
--
...
--
-- Indexes for table `detalles_gastos`
--
...
--
-- Indexes for table `detalles_presupuesto`
--
...
--
-- Indexes for table `habitantes_apartamentos`
--
...
--
-- Indexes for table `pagos_mensualidad`
--
...
--
-- Indexes for table `presupuesto_mensualidad`
--
...
--
-- Indexes for table `solicitudes_gasto`
--
...
--
-- AUTO_INCREMENT for table `anio_fiscal`
--
ALTER TABLE `anio_fiscal`
...
--
-- AUTO_INCREMENT for table `banco_transacciones`
--
ALTER TABLE `banco_transacciones`
  MODIFY `id_banco_transaccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;
...
--
-- AUTO_INCREMENT for table `detalles_gastos`
--
ALTER TABLE `detalles_gastos`
  MODIFY `id_detalle_gasto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;

--
-- AUTO_INCREMENT for table `detalles_pagos`
--
ALTER TABLE `detalles_pagos`
  MODIFY `id_detalle_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=160;

--
-- AUTO_INCREMENT for table `detalles_presupuesto`
--
ALTER TABLE `detalles_presupuesto`
...
--
ALTER TABLE `gastos`
  MODIFY `id_gasto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
...
--
-- AUTO_INCREMENT for table `habitantes_apartamentos`
--
ALTER TABLE `habitantes_apartamentos`
...
--
ALTER TABLE `movimientos_caja`
  MODIFY `id_movimiento_caja` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `pagos`
--
ALTER TABLE `pagos`
  MODIFY `id_pago` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;

--
-- AUTO_INCREMENT for table `pagos_mensualidad`
--
ALTER TABLE `pagos_mensualidad`
  MODIFY `id_pago_mensualidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
...
--
-- AUTO_INCREMENT for table `presupuesto_mensualidad`
--
ALTER TABLE `presupuesto_mensualidad`
...
--
-- AUTO_INCREMENT for table `solicitudes_gasto`
--
ALTER TABLE `solicitudes_gasto`
...
--
-- Constraints for table `banco_transacciones`
--
ALTER TABLE `banco_transacciones`
...
--
-- Constraints for table `detalles_gastos`
--
ALTER TABLE `detalles_gastos`
...
--
-- Constraints for table `detalles_presupuesto`
--
ALTER TABLE `detalles_presupuesto`
...
--
-- Constraints for table `habitantes_apartamentos`
--
ALTER TABLE `habitantes_apartamentos`
...
--
-- Constraints for table `pagos_mensualidad`
--
ALTER TABLE `pagos_mensualidad`
...
--
-- Constraints for table `presupuesto_mensualidad`
--
ALTER TABLE `presupuesto_mensualidad`
...
--
-- Constraints for table `solicitudes_gasto`
--
ALTER TABLE `solicitudes_gasto`

...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-06-2025 a las 04:55:20
...
(3, 'Evento deportivo', 'Se va a realizar un evento deportivo el dia 03 de Junio, no te lo pierdas', '2025-05-01', 'N/A', 'lenguaje_comun_1750018773.PNG', '2', 1),
(4, 'Cuadro de pagos', 'Ya esta listo el cuadro de pagos de los apartamentos, cualquier duda, contactar con la gerencia', '2025-05-01', 'N/A', 'vlcsnap-2024-05-12-05h01m32s964_1750018650.png', '1', 1),
(5, 'venta de alimentos', 'Se van a vender alimentos de Mercal el dia 10 de julio. No te lo pierdas', '2025-05-03', 'N/A', 'xam1_1750018786.PNG', '3', 1),
(6, 'Puvlica', 'publicacion sin imagen', '2025-06-14', '', '', '2', 1);
...
(4, 'Mensualidad de Apartamentos', 'Ya se asginaron las mensualidades de este mes', '2025-06-18', '0', 1),
...
--
ALTER TABLE `cartelera_virtual`
  MODIFY `id_cartelera` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `roles_permisos`
  MODIFY `id_rol_permiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=843;

<?php
    ...
    if (isset($_POST["operacion"])){
        ...
        if ($operacion == "consulta"){
            ...
            echo  json_encode($tipo_gasto_obj->consultar(true));
        }
        ...
        elseif ($operacion == "registrar") {
            ...
            echo  json_encode($presupuesto_obj->realizar_consulta('registrar'));
        }
        ...
        elseif ($operacion == "editar_presupuesto") {
            ...
            echo  json_encode($presupuesto_obj->realizar_consulta('editar'));            
        }
        ...
        elseif ($operacion == "eliminar") {
            ...
            echo  json_encode($presupuesto_obj->realizar_consulta('eliminar'));
        }
